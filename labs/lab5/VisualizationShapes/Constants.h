...
using ShapeData = std::variant<CompositeData, CircleData, RectangleData, TriangleData>;
...
namespace Constants
{
    ...
    namespace FileName
	{
        ...
        const std::string SHAPES_TXT = "SHAPES.TXT";
        const std::string SHAPES_BIN = "SHAPES.BIN";


        const std::string CURRENT_FILE = "ROBOT.TXT";
	};
	...
	namespace TypeShape
	{
        ...
        const int TRIANGLE_INT = 1;
        const int RECTANGLE_INT = 2;
        const int CIRCLE_INT = 3;
        const int COMPOSITE_INT = 4;
...
namespace ButtonToolPanel
{
    ...
    const ButtonShape BUTTON_UPLOAD_TXT = ButtonShape(sf::Vector2f(740, 10), sf::Vector2f(60, 40), sf::Color::White, sf::Color::Black, 2);
    const TextButton TEXT_UPLOAD_TXT = TextButton("Upload\n   txt", sf::Vector2f(748, 10), 15, sf::Color::Black);

    const ButtonShape BUTTON_UPLOAD_BIN = ButtonShape(sf::Vector2f(810, 10), sf::Vector2f(60, 40), sf::Color::White, sf::Color::Black, 2);
    const TextButton TEXT_UPLOAD_BIN = TextButton("Upload\n   bin", sf::Vector2f(818, 10), 15, sf::Color::Black);

    const ButtonShape BUTTON_UNLOAD_TXT = ButtonShape(sf::Vector2f(880, 10), sf::Vector2f(60, 40), sf::Color::White, sf::Color::Black, 2);
    const TextButton TEXT_UNLOAD_TXT = TextButton("Unload\n   txt", sf::Vector2f(888, 10), 15, sf::Color::Black);

    const ButtonShape BUTTON_UNLOAD_BIN = ButtonShape(sf::Vector2f(950, 10), sf::Vector2f(60, 40), sf::Color::White, sf::Color::Black, 2);
    const TextButton TEXT_UNLOAD_BIN = TextButton("Unload\n   bin", sf::Vector2f(958, 10), 15, sf::Color::Black);

    // Задний фон панели инструментов
    const ButtonShape BACKGROUND = ButtonShape(sf::Vector2f(0, 0), sf::Vector2f(1020, 60), sf::Color(30, 144, 255), sf::Color(47, 79, 79), 1);
}
