...
void IShape::SerializeTXT(std::ostream& stream) const
{
}

void IShape::SerializeBIN(std::ostream& stream) const
{
}

void IShape::DeserializeTXT(std::istream& stream)
{
}

void IShape::DeserializeBIN(std::istream& stream)
{
}
